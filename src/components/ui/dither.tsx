...
interface RetroEffectImplType extends Effect {
  colorNum: number;
  pixelSize: number;
}

class RetroEffectImpl extends Effect implements RetroEffectImplType {
...
const RetroEffect = forwardRef<RetroEffectImplType, RetroEffectProps>((props, ref) => {
...
function DitheredWaves({
  ...
  const handlePointerMove = (e: THREE.Event<PointerEvent>) => {
    ...
    mouseRef.current.set((nativeEvent.clientX - rect.left) * dpr, (nativeEvent.clientY - rect.top) * dpr);
  };
